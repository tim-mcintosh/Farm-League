...
Approved artwork covers every current catalogue object: farmhouse, barn, garden bed, pond, chicken coop, windmill, tree, fence, stone and mailbox. Their transparent PNG sprites live in `assets/`; temporary canvas drawings remain as loading and asset-error fallbacks. Per-object display scales in the renderer keep small decorations visually proportional without changing their collision footprints.
